...
latex_documents = [
    (master_doc, 'fem_labs.tex', 'fem\\_labs Documentation',
     'Vitaliy Schetinin', 'manual'),
]
...
man_pages = [
    (master_doc, 'fem_labs', 'fem_labs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fem_labs', 'fem_labs Documentation',
     author, 'fem_labs', 'One line description of project.',
     'Miscellaneous'),
]
